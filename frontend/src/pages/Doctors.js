              ...
              <Grid container spacing={3}>
                <Grid item xs={12} md={4}>
                  <Box sx={{ position: "relative" }}>
                    ...
                    <Box sx={{ mt: 2 }}>
                      <Rating
                        value={selectedDoctor.ratings?.overall || 0}
                        readOnly
                        precision={0.5}
                      />
                ...
                <Grid item xs={12} md={8}>
                  ...
                  <Box sx={{ mt: 3 }}>
                    ...
                    {selectedDoctor.availabilitySchedule?.regularHours ? (
                      ...
                      <Typography variant="body2" color="text.secondary">
                        Availability schedule not provided. Please contact the
                        hospital for timings.
                      </Typography>
                    )}
                    {selectedDoctor.availabilitySchedule
                      ?.emergencyAvailable && (
                      <Chip
                  ...
                  {selectedDoctor.publications &&
                    selectedDoctor.publications.length > 0 && (
                      <Box sx={{ mt: 3 }}>
                        <Typography variant="subtitle1" gutterBottom>
                          Publications
                        </Typography>
