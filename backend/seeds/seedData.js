...
const managementRoles = [
  {
    ...
    email: 'director@lumbinihospital.com',
  ...
  },
  {
    ...
    email: 'medical.director@lumbinihospital.com',
    password: 'medical123',
...
const seedDatabase = async () => {
  try {
    ...
    console.log('Email: firstname.lastname@lumbinihospital.com');
